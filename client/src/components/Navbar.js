...
const Navbar = () => {
    return (
        <>
            <nav className='fixed top-0 z-20 bg-slate-800 bg-opacity-50 w-full backdrop-filter backdrop-blur-2xl'>
                <div className='md:flex hidden justify-between font-dmSans p-4 items-center'>
                    ...
                    <div className='flex space-x-3'>
                        ...
                        <button className='bg-mainGreen rounded-md  text-white p-0.5 font-medium'><p className='bg-slate-800 rounded-md p-1.5 px-3 hover:text-white text-mainGreen hover:bg-mainGreen'>SignUp</p></button>
                    </div>
                </div>
